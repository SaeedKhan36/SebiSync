import type { DoclingParseResult } from "./docling-client";
...
// Splits parsed Docling output into ~300-500 token chunks, respecting section
...
export function chunkDocument(parseResult: DoclingParseResult): ChunkInput[] {
